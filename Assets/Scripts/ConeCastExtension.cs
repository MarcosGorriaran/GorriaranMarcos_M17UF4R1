...
public static class ConeCastExtension
{
    /**
     *<summary>
     *This method extends Physics with this method which allows Physics to do ConeCast by using a SphereCast and removing the gameObjects that are outside
     *of the angle or in other words it cuts the sphere to make a cone shape for the cast.
     *</summary>
     */
